...
public class ComposerActivity extends Activity {
	...
	private void openSendTextActivity() {
		Intent mSendIntent = new Intent(getApplicationContext(),
				SendTxtActivity.class);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case EXIT:
			...
			return true;
		case MAIN:
			Intent mMainIntent = new Intent(getApplicationContext(), Main.class);
			mMainIntent.putExtra("Main", "");
