       ...
       public void onClick( View v )
       {
           ...
           else if ( v.getId ( ) == R.id.sendBtn )
           {
               ...
               try
               {
                   ...
                   EditText msgTxt = ( EditText ) ComposerActivity.this.findViewById ( R.id.text );
    ...
    OnTouchListener  drag = new OnTouchListener ( )
  {
      ...
      public boolean onTouch( View v, MotionEvent event )
      {
          ...
          switch ( event.getAction ( ) )
          {
              ...
              {
                  par.topMargin = 100; /*( int ) event.getRawY ( ) - ( v.getHeight ( ) );*/
                  par.leftMargin = 100; /*( int ) event.getRawX ( ) - ( v.getWidth ( ) / 2 );*/
    ...
    public void addTextToCanvas( String text )
    {
        ...
        textToAdd = ( TextView ) itemView.findViewById ( R.id.text );
